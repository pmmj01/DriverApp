    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('have_to', models.CharField(choices=[(0, ''), ('B', 'B'), ('B+E', 'B+E'), ('C', 'C'), ('C+E', 'C+E')], max_length=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driving_license', models.CharField(choices=[(0, ''), ('B', 'B'), ('B+E', 'B+E'), ('C', 'C'), ('C+E', 'C+E')], max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plan_cargo_driver', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            ...
            name='forwarder',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cargo_forwarder', to=settings.AUTH_USER_MODEL),
        ),
    ]
